document.getElementById('add-gallery-btn').addEventListener('click', function () {
    const container = document.getElementById('gallery-fields');
...
document.getElementById('product-type').addEventListener('change', showSizes);
...
function showSizes() {
    ...
    container.innerHTML = '';
    let sizes = type === 'shoes' ? shoeSizes : (type === 'cloth' ? clothSizes : []);
